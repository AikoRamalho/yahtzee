...
def Desenha_Dados(dados,idJogadorAtual):
    ...
    button_Dado1.grid(row=15,column=0,columnspan=2,sticky=W)
    button_Dado2.grid(row=15,column=0,columnspan=2,sticky=N)
    button_Dado3.grid(row=15,column=1,columnspan=2,sticky=W)
    button_Dado4.grid(row=15,column=1,columnspan=2,sticky=N)
    button_Dado5.grid(row=15,column=2,sticky=E)
...
def Desenha_Tab(dados,idJogadorAtual):
    ...
    button_JogarDados.grid(row=16,column=0,columnspan=3)
